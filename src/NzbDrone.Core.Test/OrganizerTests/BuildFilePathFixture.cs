...
namespace NzbDrone.Core.Test.OrganizerTests
{
    ...
    public class BuildFilePathFixture : CoreTest<FileNameBuilder>
    {
        ...
        public async Task CalculateFilePath_SeasonFolder_SingleNumber(string filename, int seasonNumber, bool useSeasonFolder, string seasonFolderFormat, string expectedPath)
        {
            ...
            (await Subject.BuildFilePath(fakeEpisodes, fakeSeries, fakeEpisodeFile, ".mkv")).Should().Be(expectedPath.AsOsAgnostic());
        }

        [Test]
        public async Task should_clean_season_folder_when_it_contains_illegal_characters_in_series_title()
        {
