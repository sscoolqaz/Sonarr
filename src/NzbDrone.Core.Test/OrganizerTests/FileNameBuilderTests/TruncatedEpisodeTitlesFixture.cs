...
namespace NzbDrone.Core.Test.OrganizerTests.FileNameBuilderTests
{
    ...
    public class TruncatedEpisodeTitlesFixture : CoreTest<FileNameBuilder>
    {
        ...
        [Test]
        public async Task should_truncate_with_extension()
        {
        ...
        [Test]
        public async Task should_truncate_with_ellipsis_between_first_and_last_episode_titles()
        {
            _namingConfig.StandardEpisodeFormat = "{Series Title} - S{season:00}E{episode:00} - {Episode Title} {Quality Full}";

            var result = await Subject.BuildFileName(_episodes, _series, _episodeFile);
            result.Length.Should().BeLessOrEqualTo(255);
        ...
        [Test]
        public async Task should_truncate_with_ellipsis_if_only_first_episode_title_fits()
        {
        ...
        [Test]
        public async Task should_truncate_first_episode_title_with_ellipsis_if_only_partially_fits()
        {
            ...
            var result = await Subject.BuildFileName(new List<Episode> { _episodes.First() }, _series, _episodeFile);
            result.Length.Should().BeLessOrEqualTo(255);
        ...
        [Test]
        public async Task should_truncate_titles_measuring_series_title_bytes()
        {
        ...
        [Test]
        public async Task should_truncate_titles_measuring_episode_title_bytes()
        {
            _series.Title = "Lorem ipsum dolor sit amet, consectetur adipiscing elit Maecenas et magna sem Morbi vitae volutpat quam, id porta arcu Orci varius natoque penatibus et magnis dis parturient montes nascetur ridiculus musu Cras vestibulum";
            _namingConfig.StandardEpisodeFormat = "{Series Title} - S{season:00}E{episode:00} - {Episode Title} {Quality Full}";
        ...
        [Test]
        public async Task should_truncate_titles_measuring_episode_title_bytes_middle()
        {
            _series.Title = "Lorem ipsum dolor sit amet, consectetur adipiscing elit Maecenas et magna sem Morbi vitae volutpat quam, id porta arcu Orci varius natoque penatibus et magnis dis parturient montes nascetur ridiculus musu Cras vestibulum";
            _namingConfig.StandardEpisodeFormat = "{Series Title} - S{season:00}E{episode:00} - {Episode Title} {Quality Full}";
