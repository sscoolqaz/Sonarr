...
namespace NzbDrone.Core.Test.DecisionEngineTests
{
    ...
    public class DownloadDecisionMakerFixture : CoreTest<DownloadDecisionMaker>
    {
        ...
        public async Task should_call_all_specifications()
        {
            ...
            (await Subject.GetRssDecision(_reports)).ToList();
        ...
        [Test]
        public async Task should_call_delayed_specifications_if_non_delayed_passed()
        {
        ...
        [Test]
        public async Task should_not_call_delayed_specifications_if_non_delayed_failed()
        {
        ...
        public async Task should_return_rejected_if_single_specs_fail()
        {
            ...
            var result = await Subject.GetRssDecision(_reports);
        ...
        [Test]
        public async Task should_return_pass_if_all_specs_pass()
        {
        ...
        [Test]
        public async Task should_not_attempt_to_map_episode_if_not_parsable()
        {
            GivenSpecifications(_pass1, _pass2, _pass3);
        ...
        [Test]
        public async Task should_not_attempt_to_map_episode_if_series_title_is_blank()
        {
            GivenSpecifications(_pass1, _pass2, _pass3);
            _reports[0].Title = "1937 - Snow White and the Seven Dwarves";

            var results = (await Subject.GetRssDecision(_reports)).ToList();
        ...
        [Test]
        public async Task should_return_rejected_result_for_unparsable_search()
        {
            GivenSpecifications(_pass1, _pass2, _pass3);
            _reports[0].Title = "1937 - Snow White and the Seven Dwarves";

            (await Subject.GetSearchDecision(_reports, new SingleEpisodeSearchCriteria())).ToList();
        ...
        [Test]
        public async Task should_not_attempt_to_make_decision_if_series_is_unknown()
        {
            GivenSpecifications(_pass1, _pass2, _pass3);

            _remoteEpisode.Series = null;

            await Subject.GetRssDecision(_reports);
        ...
        [Test]
        public async Task broken_report_shouldnt_blowup_the_process()
        {
        ...
        [Test]
        public async Task should_return_unknown_series_rejection_if_series_is_unknown()
        {
            GivenSpecifications(_pass1, _pass2, _pass3);
        ...
        [Test]
        public async Task should_only_include_reports_for_requested_episodes()
        {
            ...
            Mocker.GetMock<IParsingService>()
                ...
                .ReturnsAsync((ParsedEpisodeInfo p, int _, int _, string _, SearchCriteriaBase _) =>
                    new RemoteEpisode
                    {
            ...
            var decisions = await Subject.GetSearchDecision(reports, criteria);
        ...
        [Test]
        public async Task should_not_allow_download_if_series_is_unknown()
        {
            GivenSpecifications(_pass1, _pass2, _pass3);
        ...
        [Test]
        public async Task should_not_allow_download_if_no_episodes_found()
        {
            GivenSpecifications(_pass1, _pass2, _pass3);
        ...
        public async Task should_return_a_decision_when_exception_is_caught()
        {
            ...
            (await Subject.GetRssDecision(_reports)).Should().HaveCount(1);

            ExceptionVerification.ExpectedErrors(1);
        }

        [Test]
        public async Task should_return_unknown_series_rejection_if_series_title_is_an_alias_for_another_series()
        {
            GivenSpecifications(_pass1, _pass2, _pass3);
