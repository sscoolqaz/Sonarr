...
{
    public Task<List<CustomFormat>> ParseEpisodeCustomFormats(LocalEpisode localEpisode);
    public Task UpdateEpisodeCustomFormats(LocalEpisode localEpisode);
}
...
public class LocalEpisodeCustomFormatCalculationService : ILocalEpisodeCustomFormatCalculationService
{
    ...
    public async Task<List<CustomFormat>> ParseEpisodeCustomFormats(LocalEpisode localEpisode)
    {
        var fileNameUsedForCustomFormatCalculation = await _fileNameBuilder.BuildFileName(localEpisode.Episodes, localEpisode.Series, localEpisode.ToEpisodeFile());
        return _formatCalculator.ParseCustomFormat(localEpisode, fileNameUsedForCustomFormatCalculation);
    }

    public async Task UpdateEpisodeCustomFormats(LocalEpisode localEpisode)
    {
        var fileNameUsedForCustomFormatCalculation = await _fileNameBuilder.BuildFileName(localEpisode.Episodes, localEpisode.Series, localEpisode.ToEpisodeFile());
