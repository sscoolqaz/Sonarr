...
namespace NzbDrone.Core.Datastore.SpacetimeDb
{
    public class SpacetimeDownloadClientStatusRepository : SpacetimeProviderStatusRepository<DownloadClientStatus, StdbDownloadClientStatus>, IDownloadClientStatusRepository
    {
        ...
        protected override IDisposable SubscribeOwnDeleteCommitted(Action<int> onCommitted, Action<Exception> onFailed)
        {
            ...
            Conn.Connection.Reducers.OnDeleteDownloadClientStatus += Handler;
            return new Unsubscriber(() => Conn.Connection.Reducers.OnDeleteDownloadClientStatus -= Handler);
        }
        ...
        protected override IDisposable SubscribeOwnInsertCommitted(Action onCommitted, Action<Exception> onFailed)
        {
            ...
            Conn.Connection.Reducers.OnInsertDownloadClientStatus += Handler;
            return new Unsubscriber(() => Conn.Connection.Reducers.OnInsertDownloadClientStatus -= Handler);
        }
