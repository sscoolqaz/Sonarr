...
namespace NzbDrone.Core.Datastore.SpacetimeDb
{
    public class SpacetimeImportListRepository : SpacetimeProviderRepository<ImportListDefinition, StdbImportListDefinition>, IImportListRepository
    {
        ...
        protected override IDisposable SubscribeOwnDeleteCommitted(Action<int> onCommitted, Action<Exception> onFailed)
        {
            ...
            Conn.Connection.Reducers.OnDeleteImportListDefinition += Handler;
            return new Unsubscriber(() => Conn.Connection.Reducers.OnDeleteImportListDefinition -= Handler);
        }
        ...
        protected override IDisposable SubscribeOwnInsertCommitted(Action onCommitted, Action<Exception> onFailed)
        {
            ...
            Conn.Connection.Reducers.OnInsertImportListDefinition += Handler;
            return new Unsubscriber(() => Conn.Connection.Reducers.OnInsertImportListDefinition -= Handler);
        }
