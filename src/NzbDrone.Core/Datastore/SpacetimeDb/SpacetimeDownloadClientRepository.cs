...
namespace NzbDrone.Core.Datastore.SpacetimeDb
{
    public class SpacetimeDownloadClientRepository : SpacetimeProviderRepository<DownloadClientDefinition, StdbDownloadClientDefinition>, IDownloadClientRepository
    {
        ...
        protected override IDisposable SubscribeOwnDeleteCommitted(Action<int> onCommitted, Action<Exception> onFailed)
        {
            ...
            Conn.Connection.Reducers.OnDeleteDownloadClientDefinition += Handler;
            return new Unsubscriber(() => Conn.Connection.Reducers.OnDeleteDownloadClientDefinition -= Handler);
        }
        ...
        protected override IDisposable SubscribeOwnInsertCommitted(Action onCommitted, Action<Exception> onFailed)
        {
            ...
            Conn.Connection.Reducers.OnInsertDownloadClientDefinition += Handler;
            return new Unsubscriber(() => Conn.Connection.Reducers.OnInsertDownloadClientDefinition -= Handler);
        }
        ...
        public override Task MigrateInsert(DownloadClientDefinition model) => InvokeAndWaitForMigrateInsert(model.Id, () => Conn.Connection.Reducers.MigrateInsertDownloadClientDefinition(
