...
namespace NzbDrone.Core.Datastore.SpacetimeDb
{
    public class SpacetimeQualityDefinitionRepository : SpacetimeBasicRepository<QualityDefinition, StdbQualityDefinition>, IQualityDefinitionRepository
    {
        ...
        protected override IDisposable SubscribeOwnDeleteCommitted(Action<int> onCommitted, Action<Exception> onFailed)
        {
            ...
            Conn.Connection.Reducers.OnDeleteQualityDefinition += Handler;
            return new Unsubscriber(() => Conn.Connection.Reducers.OnDeleteQualityDefinition -= Handler);
        }
        ...
        protected override IDisposable SubscribeOwnInsertCommitted(Action onCommitted, Action<Exception> onFailed)
        {
            ...
            Conn.Connection.Reducers.OnInsertQualityDefinition += Handler;
            return new Unsubscriber(() => Conn.Connection.Reducers.OnInsertQualityDefinition -= Handler);
        }
